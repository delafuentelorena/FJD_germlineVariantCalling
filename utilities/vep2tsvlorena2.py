        ...
        for line in in_f:
            ...
            if (
                ...
                if out_header!='':
                    ...
                    out_HEADER = add_new_columns(args, head, wrote_header, filteringPos) # change header
                ...
                if out_str:
                    out_STR = add_new_columns(args, head, wrote_header, filteringPos, out_str) # change line
                    if args.output_file:
                        out_f.write('%s\n' % out_STR)
                    else:
                        print(out_STR)                   
...
def add_new_columns(args, str_header, wrote_header, filteringPos, str_line=None):
